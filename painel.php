...
<head>
	<meta charset="utf-8"/>
	<title>Sistema Gilbertgram - Acesso Restrito</title>
							...
							<div class="panel panel-default c-panel">
								<div id="etapa1" style="position: relative;left: 0; opacity: 1">
									<div style="padding: 40px 60px 30px 60px">
										...
										<span class="mensagem">
											<h2>Olá <?php echo $nome; ?> <?php echo $sobrenome; ?>, seja bem vindo a área de membros.</h2>
											<p>Escolha abaixo uma das opções para seguir sua navegação.</p>
										</span>
										<div class="row" style="padding: 20px 0px 20px 0px">
										  	<div class="col-md-12">
										      <label class="form-input">
										      	<button type="button" data-toggle="modal" data-target="#sair-sistema" class="btn btn-danger btn-md" style="width:100%"><i class="fa fa-sign-out"></i> SAIR DO SISTEMA</button> 
										      </label>
											 </div>
									 	</div>
									</div>
...
<div class="modal fade c-content-suporte-form" id="sair-sistema" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content c-square">
            ...
            <div class="modal-body">
                <p style="text-align:justify">Deseja encerrar a sua sessão?
                </p>
            </div>
            <div class="modal-footer">  
            <a onclick="sair()"><button type="button" class="btn c-theme-btn c-btn-square c-btn-bold c-btn-uppercase">Sair</button></a>              
            <button type="button" class="btn c-theme-btn c-btn-border-2x c-btn-square c-btn-bold c-btn-uppercase" data-dismiss="modal">Fechar</button>
          </div>
        </div>
    </div>
