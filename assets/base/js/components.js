...
var LayoutQuickSidebar = function () {
	...
	return {
		...
		init: function () {
			...
			$('.c-layout-quick-sidebar').on('click', '.c-close', function (e) {
				e.preventDefault();
				e.stopPropagation();<!--remover-->

				//$('body').removeClass("c-layout-quick-sidebar-shown");
				if ($('body').hasClass("c-layout-quick-sidebar-shown")) {
					$('body').removeClass("c-layout-quick-sidebar-shown");
					$('#lateral').css({'left':'0px', 'transition':'left 0.2s'});
					$('#bot-lat').removeClass("icon-login");
					$('#bot-lat').addClass("icon-logout");
				} else {
					$('body').addClass("c-layout-quick-sidebar-shown");
					$('#lateral').css({'left':'-193px', 'transition':'left 0.2s'});
					$('#bot-lat').addClass("icon-login");
					$('#bot-lat').removeClass("icon-logout");
				}
			});
